...
num_games = 0
num_active = 0
# f = open("Data/data_bits_normal_not_capture_lichess.csv", "w")

for i in range(1492283):
    if num_games % 1000 == 0:
        print(num_games, num_games * 100 / 1492283, num_active)
    ...
    if (len_bits >= 12 and rating > 2500 and "1/2" not in game.headers["Result"]):
        num_active += 1
